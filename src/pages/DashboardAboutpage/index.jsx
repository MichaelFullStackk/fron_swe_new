      ...
      <div className="bg-gray-300 flex flex-col font-lexenddeca relative mx-auto w-full h-screen">
        ...
        <div className="flex flex-col items-center justify-center w-full h-full mt-5 gap-3">
          <div className="mt-[100px]">
            ...
            >
              We are the complany that provide professional translator serevices
            </Text>
            <Text
              className="text-4xl md:text-2xl text-blue_gray-800 text-center mt-5" //sm:text-[32px]
              size="txtLexendDecaRegular36"
            >
              We gurante perfect quality and saftety of your materials
            </Text>
          </div>
          {/* <Text
            className="text-2xl md:text-2xl text-blue_black-800 text-center mt-[30vh]" //sm:text-[32px]
            size="txtLexendDecaRegular36"
          >
        ...
        <div className="flex flex-col items-center w-full">
          ...
          >
            {/* <Text
              className="text-2xl md:text-2xl text-blue_black-800 text-center mt-10"
              size="txtLexendDecaRegular36"
            >
              2024 all rights reserved
            </Text> */}
            ...
            />
            <Text
              className="text-2xl md:text-2xl text-blue_black-800 text-center mb-[100px]"
              size="txtLexendDecaRegular36"
            >
              2024 all rights reserved ©
            </Text>
...
export default DashboardAboutpagePage;
